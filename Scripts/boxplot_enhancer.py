...
df_drm_pcc = pd.read_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\out_TSS\\out_TSS_drm_pcc.csv', header = 0)
df_drm_scc = pd.read_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\out_TSS\\out_TSS_drm_scc.csv', header = 0)
df_ndrm_pcc = pd.read_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\out_TSS\\out_TSS_ndrm_pcc.csv', header = 0)
df_ndrm_scc = pd.read_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\out_TSS\\out_TSS_ndrm_scc.csv', header = 0)
...
df_H3K4me1_H3K4me3_1peak = df_H3K4me1_H3K4me3[(df_H3K4me1_H3K4me3['H3K4me1_peak'] == 1) & (df_H3K4me1_H3K4me3['H3K27ac_peak'] == 1) & (df_H3K4me1_H3K4me3['H3K4me3_peak'] == 1)]
df_H3K4me1_H3K4me3_1peak.boxplot(column = ['drm_pcc', 'drm_scc', 'ndrm_pcc', 'ndrm_scc'])
plt.title('Enhancer_region_H3K4me1_H3K4me3')
plt.show()
df_H3K4me1_H3K4me3_1peak.to_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\enhancer\\enhancer_H3K4me1_H3K4me3_CC.csv', index = False)
...
df_H3K4me1_H3K27ac_1peak = df_H3K4me1_H3K27ac[(df_H3K4me1_H3K27ac['H3K4me1_peak'] == 1) & (df_H3K4me1_H3K27ac['H3K27ac_peak'] == 1)]
df_H3K4me1_H3K27ac_1peak.boxplot(column = ['drm_pcc', 'drm_scc', 'ndrm_pcc', 'ndrm_scc'])
plt.title('Enhancer_region_H3K4me1_H3K27ac')
plt.show()
df_H3K4me1_H3K27ac_1peak.to_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\enhancer\\enhancer_H3K4me1_H3K27ac_CC.csv', index = False)
...
plt.show()
df_H3K4me3_H3K27ac_1peak.to_csv('D:\\G_project\\Zhen_G\\data\\CorrelationC\\enhancer\\enhancer_H3K4me3_H3K27ac_CC.csv', index = False)