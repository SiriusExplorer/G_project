...
# m_H3K3me3_ndrm = parse_xls_to_matrix('..\data\LCLs_C2.C1Y12_ref_norm_signals\LCLs_C2.H3K4me3_ndrm_norm_signals.xls')
# m_H3K27ac_ndrm = parse_xls_to_matrix('..\data\LCLs_C2.C1Y12_ref_norm_signals\LCLs_C2.H3K27ac_ndrm_norm_signals.xls')

with open('drm_scc.xls', 'w') as file:
    ...
    for i in range(len(m_H3K4me1_drm))[1:]:
        H3K4me1_peak = findpeak(m_H3K4me1_drm[i][50:97])
        H3K4me3_peak = findpeak(m_H3K4me3_drm[i][50:97])
        H3K27ac_peak = findpeak(m_H3K27ac_drm[i][50:97])
        line = m_H3K4me1_drm[i][0:3] + list(stats.spearmanr(m_H3K4me1_drm[i][3:50], m_H3K4me3_drm[i][3:50])) + list(stats.spearmanr(m_H3K4me1_drm[i][3:50], m_H3K27ac_drm[i][3:50])) + list(stats.spearmanr(m_H3K4me3_drm[i][3:50], m_H3K27ac_drm[i][3:50])) + H3K4me1_peak + H3K4me3_peak + H3K27ac_peak
